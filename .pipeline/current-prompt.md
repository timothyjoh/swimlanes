...
2. **Phase Research**: `docs/phases/phase-2/RESEARCH.md` — current codebase state
3. **Previous Reflections**: `Previous phase reflections (read this file): /Users/timothyjohnson/wrk/swimlanes/docs/phases/phase-1/REFLECTIONS.md` — lessons from last phase (if exists)
...
Output to `docs/phases/phase-2/PLAN.md`:
